...
function calculatePrice() {
  let totalItemToPurchase = document.querySelector(".bag-summary");
  ...
  totalItemToPurchase.innerHTML = `<div class="bag-details-container">
...
function displayBagItems() {
  ...
  let cartHTML = "";
  BagItemsObject.forEach((bagItem) => {
    cartHTML += createInterface(bagItem);
  });
